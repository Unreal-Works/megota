 ...
 * @return `true` if this number is greater than or equal to the other, otherwise `false`.
 */
function greaterThanOrEquals(value: BaseMegota, other: BaseMegota, abs?: boolean): boolean {
